...
//  QString filename = QFileDialog::getOpenFileName(this, tr("Open ifc file"), QString(), tr("ifc STEP file (*.dxf)"));
//  if(!filename.isEmpty()) {
//	  ImportDXFDialog *diag = new ImportDXFDialog(this);
//	  diag->importFile(filename);
//  }
//  else {
...
void MainWindow::loadPlugins() {
	...
	for( QString filename : pluginsDir.entryList(QDir::Files)) {
		...
		if(loader.instance() != nullptr) {
			...
			if(filename == "DXFImportPlugin.dll") {
