...
/*! A manager class for handling widgets that can be "split" and "joined".
	...
	\endcode
*/
class QtExt_EXPORT SplitWidget : public QWidget {
	Q_OBJECT
public:
...
class QtExt_EXPORT SplitWidgetHandle : public QSplitterHandle {
	Q_OBJECT
public:
...
class QtExt_EXPORT SplitWidgetSplitter : public QSplitter {
	Q_OBJECT
public:
