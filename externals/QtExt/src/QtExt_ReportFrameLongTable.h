...
*/
class QtExt_EXPORT ReportFrameLongTable : public QtExt::ReportFrameBase {
...
public:
	...
	*/
	...
	/*! Configure the internal table.
		...
		Don't call Table::clear() inside this function.
	*/
	virtual void configureTable() = 0;

	/*! Configure the heading above the table.
		Must be implemented by derived class.
		Can be an empty function in case you don't have a heading.
	*/
