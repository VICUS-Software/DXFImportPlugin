...
class QtExt_EXPORT TextEditorExtended : public QPlainTextEdit
{
public:
...
private:
    ...
    /*! Highlights the current line with given color.*/
...
class QtExt_EXPORT LineNumberAereaWidget : public QWidget
{
	Q_OBJECT
public:
