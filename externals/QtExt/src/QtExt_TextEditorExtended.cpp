...
void TextEditorExtended::highlightCurrentLine() {
	...
	if (!isReadOnly()) {
        ...
        QColor lineColor = QColor(m_highlightColor).lighter(160);
...
QColor TextEditorExtended::highlightColor() const {
    return m_highlightColor;
}

void TextEditorExtended::setHighlightColor(const QColor &newHighlightColor) {
