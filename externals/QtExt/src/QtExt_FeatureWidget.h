...
/*! This class is a widget container that contains a subwidget and a title bar with
	shade buttons and optionally plus and minus buttons and other buttons.
...
*/
class QtExt_EXPORT FeatureWidget : public QWidget {
	Q_OBJECT
public:
	...
	explicit FeatureWidget(QWidget * parent, QWidget * content = nullptr,
...
private slots:
	...
	*/
	void onShadeButtonClicked(bool);
...
private:
	...
	/*! Pointer to the content widget.
		If no widget has been specified in constructor, a default widget is used.
	*/
