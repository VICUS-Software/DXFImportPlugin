...
*/
class QtExt_EXPORT ConstructionGraphicsSceneHorizontal : public ConstructionGraphicsSceneBase
{
	Q_OBJECT
public:
	...
	*/
	ConstructionGraphicsSceneHorizontal(bool onScreen, QPaintDevice *device, QObject* parent = 0);
...
private:
	...
	void drawDimensions() override;

	/*! Draws the wall including hashing.*/
	void drawWall() override;

	/*! Draw marker lines then exist.*/
	void drawMarkerLines() override;

	/*! Draw a marker area rect.*/
	void drawMarkerArea() override;
