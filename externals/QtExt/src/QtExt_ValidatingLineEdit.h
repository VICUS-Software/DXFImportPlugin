...
/*!	\brief Class ValidatingLineEdit provides validation functionality for entered double numbers and
	...
	\endcode
*/
class QtExt_EXPORT ValidatingLineEdit : public QLineEdit, public ValidatingInputBase {
	Q_OBJECT
public:
	/*! Default c'tor. */
...
private:
	/*! Guard flag that prevents emitting editingFinishedSuccessfully multiple times */
	bool m_editingFinishedEmitted = false;
};
