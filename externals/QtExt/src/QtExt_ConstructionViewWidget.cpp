                                     ...
                                     int visibleItems, bool horizontal)
{
	m_fixed = fixed;
	enableToolBar(false);
	ui->graphicsView->m_leftTopSideLabel = leftSideLabel;
	ui->graphicsView->m_rightBottomSideLabel = rightSideLabel;
    ui->graphicsView->setData(this, layers, 1.0, visibleItems, horizontal);
}
