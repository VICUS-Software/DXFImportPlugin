...
#ifndef QtExt_ReportFrameItemTextFrameH
#define QtExt_ReportFrameItemTextFrameH
...
class QtExt_EXPORT ReportFrameItemTextFrame : public QtExt::ReportFrameItemBase
{
public:
...
#endif // QtExt_ReportFrameItemTextFrameH
