...
QtExt_EXPORT double QString2Double(const QString & str, bool * ok = nullptr);

/*! Converts a text "121 m" into a parameter. */
QtExt_EXPORT bool QString2Parameter(const QString & str, const std::string & keywordName, IBK::Parameter & para);
...
*/
QtExt_EXPORT QString parameter2String(const IBK::Parameter & para);
