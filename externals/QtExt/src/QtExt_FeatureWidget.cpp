	...
	m_previousShadeState(false)
{
	...
	connect(m_shadeButton, QOverload<bool>::of(&IconButton::clicked), this, &FeatureWidget::onShadeButtonClicked);
	...
	connect(m_recycleButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::recycleClicked);
	...
	connect(m_copyButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::copyClicked);
	...
	connect(m_plusButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::plusClicked);
	...
	connect(m_minusButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::minusClicked);
	...
	connect(m_moveUpButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::moveUpClicked);
	...
	connect(m_moveDownButton, QOverload<>::of(&IconButton::clicked), this, &FeatureWidget::moveDownClicked);


	m_titleLabel = new ActiveLabel(this);
	m_titleLabel->setMaximumHeight(20);
	connect(m_titleLabel, QOverload<bool>::of(&ActiveLabel::clicked), this, &FeatureWidget::onShadeButtonClicked);
...
void FeatureWidget::readSettings( QSettings& settings ) {
	Q_ASSERT(m_contentWidget != nullptr);
...
void FeatureWidget::onShadeButtonClicked(bool checked) {
	Q_UNUSED(checked)
