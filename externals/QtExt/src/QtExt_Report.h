...
class QtExt_EXPORT Notification : public IBK::NotificationHandler {
public:
	bool	m_aborted = false;
};

class QtExt_EXPORT Report : public QObject
{
	Q_OBJECT
...
public:
	...
	*/
	virtual void print(QPrinter * printer, QFont normalFont, Notification *notify = nullptr);
