...
#ifndef QtExt_ReportFrameItemImageH
#define QtExt_ReportFrameItemImageH
...
class QtExt_EXPORT ReportFrameItemImage : public QtExt::ReportFrameItemBase
{
public:
	ReportFrameItemImage(const QPixmap* pixmap, QPaintDevice* paintDevice, double width, double spaceAfter = 0, double spaceBefore = 0, bool canPageBreakAfter = false);
...
#endif // QtExt_ReportFrameItemImageH
