...
unsigned int ReportFrameTablePart::numberOfSubFrames(QPaintDevice* , double , double ) const {
	return 1;
}

std::vector<QtExt::ReportFrameBase*> ReportFrameTablePart::subFrames(QPaintDevice* , double , double ) {
