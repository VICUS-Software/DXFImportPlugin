...
#endif
#include <src/gtx/dual_quaternion.hpp>
#include <src/gtc/vec1.hpp>
#include <src/gtc/quaternion.hpp>
#include <src/ext/scalar_int_sized.hpp>
#include <src/ext/scalar_uint_sized.hpp>
#include <src/glm.hpp>
